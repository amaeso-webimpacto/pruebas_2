...
<div class="panel">
	<h3><i class="icon icon-credit-card"></i> {l s='Show Images' mod='showimg'}</h3>
	<p>
		<strong>{l s='Here is my new generic module!' mod='showimg'}</strong><br />
		{l s='Thanks to PrestaShop, now I have a great module.' mod='showimg'}<br />
		{l s='I can configure it using the following configuration form.' mod='showimg'}
	</p>
	<br />
	<p>
		{l s='This module will boost your sales!' mod='showimg'}
	</p>
</div>

<div class="panel">
	<h3><i class="icon icon-tags"></i> {l s='Documentation' mod='showimg'}</h3>
	<p>
		&raquo; {l s='You can get a PDF documentation to configure this module' mod='showimg'} :
		<ul>
			<li><a href="#" target="_blank">{l s='English' mod='showimg'}</a></li>
			<li><a href="#" target="_blank">{l s='French' mod='showimg'}</a></li>
		</ul>
	</p>
</div>
